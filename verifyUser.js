...
module.exports = {
	...
	//	var bcrypt = require('bcrypt');
		...
		const queryFindUser = {
		  ...
		  name: 'fetch-user',
		  text: 'SELECT user_name, password FROM users WHERE user_name ILIKE $1',  //SELECT user_name, password FROM users WHERE exists(SELECT 1 FROM users WHERE user_name ILIKE $1 LIMIT 1)
		  values: [userName]
		}
